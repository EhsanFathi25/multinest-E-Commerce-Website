            ...
            <div className="w-full fixed top-0 bg-white shadow-sm z-50">
                <nav className="flex flex-wrap items-center justify-between px-10 py-3 w-full">
                    ...
                    <Link to="/" className="mx-auto order-0 lg:hidden flex">
                        <h2 className="text-3xl font-bold font-bricolage tracking-widest">
                            Multi
                            <span className="font-bricolage">nest</span>
                        </h2>
                    </Link>
                    ...
                    <ul className="lg:hidden flex items-center gap-4">
                        <li className="relative">
                            <Link to="/Wishlist">
                                ...
                                <span className="absolute -top-2 -right-2 w-[22px] h-[22px] text-xs
                    ...
                    <div className={`w-full lg:flex justify-between items-center 
                        ...
                        <ul className="flex flex-col lg:flex-row items-center gap-4">
                            <li>
                                <Link to="/" className="font-bold uppercase relative nav-link py-1">
                                    Home
                                </Link>
                            </li>

                            <li>
                                <Link to="/About" className="font-bold uppercase relative nav-link py-1">
                                    About
                                </Link>
                            </li>

                            <li>
                                <Link to="/Shop" className="font-bold uppercase relative nav-link py-1">
                                    Shop
                                </Link>
                            </li>

                            <li>
                                <Link to="/Blog" className="font-bold uppercase relative nav-link py-1">
                                    Blog
                                </Link>
                            </li>

                            <li>
                                <Link to="/Contact" className="font-bold uppercase relative nav-link py-1">
                                    Contact
                                </Link>
                            </li>
                        </ul>
